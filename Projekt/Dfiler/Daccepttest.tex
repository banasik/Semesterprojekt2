...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
	...
	~ &\textit{Exentions} & ~ & ~ & 
	\\ \midrule	
    2a. &	Username eller password er forkert &    Messageboks vises på skærmen med tekst der informerer om, at brugernavn eller password er forkert  &   ~  &		%{\Huge \checkmark}
 \\ \bottomrule
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
	...
	&\textit{Hovedscenarie} & & & 
	\\ \midrule
	1. &Indtast virtuelt patients CPR-nummer & Indstillinger bliver valgt & & %{\Huge \checkmark}
	\\
	2. &Vælg indstillinger & Indstillinger bliver valgt & & %{\Huge \checkmark}
	\\
	3. & Tryk på "Start" & Målingen startes i EKG-vinduet & & %{\Huge \checkmark}
	\\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    \\
    2. &Indtaster den virtuelle patientens CPR-nummer, dato og diagnose for den givne måling	 &   CPR-nummer-, dato- og diagnoseboks bliver udfyldt &     ~ &		%{\Huge \checkmark}
    \\
