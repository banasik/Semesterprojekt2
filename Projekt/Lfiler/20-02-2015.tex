...
Sara: Skrevet implemtentering, design og test til rapport samt hvordan visningen af EKG-signalet fungere i dokumentation.
...
Tilføjet kapitlet 'Krav' til rapporten. 

\section{Dato: 26-05-2015}
\hrule

\textbf{Omhandler:} Rettelse af rapport og dokumentation 

\textbf{Ansvarlige:} Lise og Mads

\textbf{Logbog}

Vi har i dag læst begge dokumenter igennem. Vi har forsøgt at finde alle stavefejl/skrivefejl. Vi har omformuleret en smule, og håber det bliver modtaget godt i morgen. 
I morgen skal vi dog stadigvæk være opmærksom på komma, stavefejl osv. 

Vi har også opdateret versionshistorikkerne i dokumentationen, samt lavet den for rapporten. 

\section{Dato: 26-05-2015}
\hrule

\textbf{Omhandler:} Diskussion

\textbf{Ansvarlige:} Malene

\textbf{Logbog}

Diskussionen er blevet skrevet således at den beskriver overvejelser omkring de resultater vi har lavet, og hvordan det kunne være blevet bedre, og hvorfor resultaterne er som de er.

\section{Dato: 26-05-2015}
\hrule

\textbf{Omhandler:} Resumé + konklusion + personlig erfaringer

\textbf{Ansvarlige:} Alle 

\textbf{Logbog}

Resumé og konklusion er blevet skrevet og tilføjet rapporten. Resumé er skrevet både på dansk og engelsk. Desuden er der skrevet individuelle erfaringer.

\section{Dato: 27-05-2015}
\hrule

\textbf{Omhandler:} De sidste rettelser

\textbf{Ansvarlige:} Alle

\textbf{Logbog}

Rapporten og dokumentationen er blevet gennemrettet af hele gruppen, så alle kan stå inde for indholdet inden aflevering. 
