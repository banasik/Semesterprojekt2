...
\begin{longtabu} to \linewidth{@{}l r X[j]@{}} %UC1%
    ...
    Undtagelser &    1a. &    Der blev ikke ændret i indstillingerne. Der fortsættes ved punkt 2 i hovedforløbet med default indstillingerne \\
...
\begin{longtabu} to \linewidth{@{}l r X[j]@{}} %UC2%
    ...
    Undtagelser &    3a. &    Det er ikke muligt at analysere HRV ud fra grafen. Use case 2 afsluttes og Use case 1 gentages med evt. nye tidsindstillinger \\
